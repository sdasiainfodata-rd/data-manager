...
public class RoleController {
    ...
    @Log("修改角色中台权限")
    @PutMapping(value = "/roles/url")
    @PreAuthorize("hasAnyRole('ADMIN','ROLES_ALL','ROLES_EDIT')")
    public ResponseEntity updateUrl(@RequestBody Role resources){
        roleService.updateUrl(resources,roleService.findById(resources.getId()));
        return new ResponseEntity(HttpStatus.NO_CONTENT);
    }
}
