...
//        String encryptPassword = EncryptUtils.encryptPassword(authorizationUser.getPassword());
        String rowPassword = authorizationUser.getPassword();
        String encodePassword = jwtUser.getPassword();
        BCryptPasswordEncoder bCryptPasswordEncoder = new BCryptPasswordEncoder();
        if(!bCryptPasswordEncoder.matches(rowPassword,encodePassword )){
